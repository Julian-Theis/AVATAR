...
if __name__ == "__main__": 
    pn = "pb_system_4_1.pnml"
    f_pop = "pb_system_4_1_30_pop.txt"
    f_train = "pb_system_4_1_30_train.txt"
    f_test = "pb_system_4_1_30_test.txt"
    ...
    train_indices, test_indices = train_test_split(indices, train_size=0.3)
